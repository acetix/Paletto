...
export default function AppCore() {
  ...
  return <div className="app-shell">
    <nav className="navbar navbar-expand-lg topbar"><div className="container-fluid app-container px-0"><a className="navbar-brand brand-mark" href="#top" aria-label="Paletto by Acetix home"><span className="brand-icon"><i /><i /><i /><i /></span><span style={{ display: 'flex', flexDirection: 'column', gap: 2, lineHeight: 1 }}><span>Paletto<span className="brand-period">.</span></span><small style={{ fontSize: 9, fontWeight: 500, letterSpacing: '.2px', lineHeight: 1.1, color: '#89867f' }}>by Acetix</small></span></a><div className="top-nav"><a href="#how-it-works">How it works</a><a href="#about">About</a><a href="/privacy">Privacy</a><span className="nav-divider" /><span className="local-badge"><LockKeyhole size={13} /> Private by design</span></div><button className="btn btn-dark header-button" onClick={() => fileInput.current?.click()}><ImagePlus size={16} /> New palette</button></div></nav>
